...
public class FdActivity extends Activity implements CvCameraViewListener2 {
    ...
    EditText text,text1,text2,text3,text4,text5;
    TextView textresult;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        text1.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((text1.getText().toString().length()>0)&&(toggleButtonTrain.isChecked()))
                    toggleButtonGrabar.setVisibility(View.VISIBLE);
                else
                    toggleButtonGrabar.setVisibility(View.INVISIBLE);
        ...
        text2.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((text2.getText().toString().length()>0)&&(toggleButtonTrain.isChecked()))
                    toggleButtonGrabar.setVisibility(View.VISIBLE);
                else
                    toggleButtonGrabar.setVisibility(View.INVISIBLE);
        ...
        text3.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((text3.getText().toString().length()>0)&&(toggleButtonTrain.isChecked()))
                    toggleButtonGrabar.setVisibility(View.VISIBLE);
                else
                    toggleButtonGrabar.setVisibility(View.INVISIBLE);
        ...
        text4.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((text4.getText().toString().length()>0)&&(toggleButtonTrain.isChecked()))
                    toggleButtonGrabar.setVisibility(View.VISIBLE);
                else
                    toggleButtonGrabar.setVisibility(View.INVISIBLE);
        ...
        toggleButtonTrain.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				if (toggleButtonTrain.isChecked()) {
                    ...
                    ParseObject obj = new ParseObject("person");
                    obj.put("id", text.getText().toString());
                    obj.put("name",text1.getText().toString());
                    obj.put("age",text2.getText().toString());
                    obj.put("sex", text3.getText().toString());
                    obj.put("education", text4.getText().toString());
                    obj.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                ...
                                AlertDialog.Builder b = new AlertDialog.Builder(FdActivity.this);
...
//                mNativeDetector.detect(mGray, faces);
        ...
        if ((facesArray.length==1)&&(faceState==TRAINING)&&(countImages<MAXIMG)&&(!text.getText().toString().isEmpty())
                &&(!text1.getText().toString().isEmpty())&&(!text2.getText().toString().isEmpty())&&(!text3.getText().toString().isEmpty())&&(!text4.getText().toString().isEmpty())  )
        {
       ...
       // SaveBmp(mBitmap,"/sdcard/db/I("+countTrain+")"+countImages+".jpg");
        ...
        if (countImages<MAXIMG)
        {
            ...
            //adding the person name and image to file
